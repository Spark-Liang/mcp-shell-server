...
from mcp_shell_server.interfaces import ProcessStatus, ProcessInfo
...
def test_list_processes_api(client):
    ...
    with patch('mcp_shell_server.background_process_manager_web.process_manager') as mock_manager:
        ...
        with patch('mcp_shell_server.background_process_manager_web.asyncio') as mock_asyncio:
            mock_loop = MagicMock()
